 ...
 * @since 5/9/2024
 */
public class KillStreakLeaderBoardStat implements ILeaderBoardStat {
    ...
    public Double getValue(UUID playerUUID) {
        return (double) LegendBukkit.getInstance().getUserHandler().getUser(playerUUID).getCurrentKillStreak();
    }
